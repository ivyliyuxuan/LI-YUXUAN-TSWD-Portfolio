...
## ❔ Why Florish
&emsp;▪️ Easily turn our data into stunning charts, maps and interactive stories.<br>

&emsp;▪️ Create agency-quality data graphics and animated stories that bring your data to life.<br>

&emsp;▪️ Flourish is easy enough for anyone to use. Start with a template and drop in data.<br>

&emsp;▪️ Create seamless embeds, magical presentations, or engaging content for social.<br>
...
&emsp;▪️ I think the charts allow the viewer to quickly compare trends across countries, debt-to-GDP ratio for different countries in the same year and debt-to-GDP ratio for the same country in different years.<br>
 
&emsp;▪️ Because the grid of line chart includes many line charts, I use a uniform color to make the chart less cluttered.<br>
...
&emsp;▪️ although there are ups and downs in many continents，they are all on a rising trend.<br>
...
&emsp;▪️ I think the charts allow the viewer to quickly compare trends across continents, debt-to-GDP ratio for different continents in the same year and debt-to-GDP ratio for the same continents in different years.<br>
 
&emsp;▪️ Because the grid of column chart includes many column charts, I use a uniform color to make the chart less cluttered.<br>
